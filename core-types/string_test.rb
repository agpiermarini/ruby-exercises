...
class StringTest < Minitest::Test
  ...
  def test_squeeze
    #deletes only parallel instances...e.g. pupies
    ...
    #deletes everything after first space
  ...
  #goes to next in sequence...z returns the the beggining of the sequence and pushes a to front
  def test_next
  ...
  def test_shovel
    ...
    assert_equal "hello!", "hello" << 33     #looks at 33 as a code point, and 33 = !
  end
  ...
  def test_tr  #tr transforms [from_string, to_string]
    ...
    assert_equal "        GO ", "1, 2, 3 GO!".tr('^A-Z', ' ')   #^A-Z will transform all non-alphabetic characters
