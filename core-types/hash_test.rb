...
class HashTest < Minitest::Test
  ...
  def test_include
    ...
    refute boolean                                    #can #include? for keys, not for values
  end
  ...
  def test_member
    ...
    boolean = {}.member?("a")
    refute boolean
    boolean = {"a" => "apple"}.member?("a")           #member checks keys
    assert boolean
  ...
  def test_member_and_include_and_key_with_symbols_and_strings
    ...
    refute boolean
    boolean2 = {cake: "yummy"}.include?(:cake)
    assert boolean2
    boolean3 = {"cake": "yummy"}.member?("cake")
    refute boolean3
    boolean4 = {"cake": "yummy"}.member?(:cake)
    assert boolean4
    boolean5 = {cake: "yummy"}.key?(:cake)
    assert boolean5
    boolean6 = {cake: "yummy"}.include?("yummy")
    refute boolean6
    boolean7 = {cake: "yummy"}.member?("yummy")
    refute boolean7
    boolean8 = {"cake": "yummy"}.key?("yummy")
    refute boolean8
  end
